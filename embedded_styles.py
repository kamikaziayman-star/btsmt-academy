...
a[data-testid="stLinkButton"]:hover {
    ...
    box-shadow: 0 14px 30px rgba(6, 38, 90, 0.12) !important;
}
...
.exam-card,
.planning-card {
    animation: academicPageIn 0.46s cubic-bezier(0.22, 0.84, 0.24, 1) both;
}
...
.message:hover,
.homework-card:hover,
.university-announcement:hover {
    transform: translateY(-4px);
    border-color: rgba(22, 119, 255, 0.28);
    box-shadow: 0 22px 48px rgba(6, 38, 90, 0.14);
}
...
.university-feature-card,
.shared-file-card {
    animation: academicCardIn 0.48s cubic-bezier(0.22, 0.84, 0.24, 1) both;
}

.dashboard-stat:nth-of-type(2),
.dashboard-stat-card:nth-of-type(2),
.subject-card:nth-of-type(2),
.drive-file-row:nth-of-type(2) {
    animation-delay: 0.04s;
}

.dashboard-stat:nth-of-type(3),
.dashboard-stat-card:nth-of-type(3),
.subject-card:nth-of-type(3),
.drive-file-row:nth-of-type(3) {
    animation-delay: 0.08s;
}

.dashboard-stat:nth-of-type(4),
.dashboard-stat-card:nth-of-type(4),
.subject-card:nth-of-type(4),
.drive-file-row:nth-of-type(4) {
...
a[data-testid="stLinkButton"]::after {
    content: "";
    position: absolute;
    top: -40%;
    left: -65%;
...
a[data-testid="stLinkButton"]:hover::after {
    left: 125%;
}
...
[data-baseweb="select"] > div:focus-within {
    border-color: rgba(22, 119, 255, 0.52) !important;
...
@keyframes academicHeroGlow {
    from { transform: translate3d(-8%, -5%, 0) rotate(0deg); opacity: 0.40; }
    to { transform: translate3d(7%, 5%, 0) rotate(2deg); opacity: 0.72; }
}
...
@keyframes progressShine {
    ...
    42%, 100% { transform: translateX(115%); }
}
...
.planning-hero {
    ...
    box-shadow: var(--bts-shadow);
    color: #fff !important;
    animation: academicPageIn 0.54s cubic-bezier(0.22, 0.84, 0.24, 1) both;
}
...
.academic-dashboard-hero::after,
.courses-hero::after,
.files-hero::after,
.exam-hero::after,
.planning-hero::after,
.platform-login-hero::after,
.academic-welcome-panel::after {
    content: "";
    position: absolute;
    inset: -35%;
    z-index: 0;
    ...
    background:
        ...
        radial-gradient(circle at 74% 58%, rgba(93, 181, 255, 0.18), transparent 26%);
    opacity: 0.55;
    pointer-events: none;
    animation: academicHeroGlow 8s ease-in-out infinite alternate;
}
...
.planning-art {
    ...
    opacity: 0.9;
    animation: academicFloat 5.8s ease-in-out infinite;
}
